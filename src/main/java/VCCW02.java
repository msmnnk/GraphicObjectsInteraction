 ...
 * from the initial file of lab 3 (VC03.java)
 */
...
public class VCCW02 {
    ...
    public VCCW02() {
        ...
        animator.add(window);
        window.setTitle("Coursework 2"); // set window title
    ...
    class Renderer implements GLEventListener {
        ...
        public void display(GLAutoDrawable drawable) {
            ...
            // TASK 2c: transform the first object (a sphere)
            T.initialize();
            T.scale(0.25f, 0.25f, 0.25f);
            T.translate(0.0f, 0.44f, 0.44f);
            // locate camera
            ...
            // bind and draw the first object (a sphere)
            idPoint = 0;
            idBuffer = 0;
            idElement = 0;
            bindObject(gl);
            ...
            // TASK 2c: transform the second object (a cone)
            T.initialize();
            T.rotateX(-90);
            T.scale(0.25f, 0.25f, 0.25f);
            T.translate(0, -0.18f, -0.18f);
            gl.glUniformMatrix4fv(ModelView, 1, true, T.getTransformv(), 0);
            gl.glUniformMatrix4fv(NormalTransform, 1, true, T.getInvTransformTv(), 0);
            ...
            // bind and draw the second object (a cone)
            idPoint = 1;
            idBuffer = 1;
            idElement = 1;
            bindObject(gl);
        ...
        public void init(GLAutoDrawable drawable) {
            ...
            float[] lightPosition = {20.0f, 30.0f, 30.0f, 1.0f};
            Vec4 lightAmbient = new Vec4(0.5f, 1.0f, 0.7f, 1.0f);
            ...
            // TASK 2b: create the second object (a cone)
            SObject cone = new SCone(1,1.5f);
            idPoint = 1;
            idBuffer = 1;
            idElement = 1;
            createObject(gl, cone);
            // TASK 2b: set cone material (turquoise)
            Vec4 materialAmbient2 = new Vec4(0.1f, 0.18725f, 0.1745f, 0.8f);
            Vec4 materialDiffuse2 = new Vec4(0.396f, 0.74151f, 0.69102f, 0.8f);
            Vec4 materialSpecular2 = new Vec4(0.297254f, 0.30829f, 0.306678f, 0.8f);
            materialShininess2 = 12.8f;
            ambient2 = lightAmbient.times(materialAmbient2).getVector();
            diffuse2 = lightDiffuse.times(materialDiffuse2).getVector();
            specular2 = lightSpecular.times(materialSpecular2).getVector();
